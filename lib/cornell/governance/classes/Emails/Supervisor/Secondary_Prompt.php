...
namespace Cornell\Governance\Emails\Supervisor {
	...
	if ( ! class_exists( '\Cornell\Governance\Emails\Supervisor\Secondary_Prompt' ) ) {
		class Secondary_Prompt extends \Cornell\Governance\Emails\Secondary_Prompt {
			...
			protected function __construct() {
				...
				$this->set_vars( array(
					'subject' => sprintf( esc_html( __( '[Secondary Contact Report] [Website Report] Pages needing review in the next %d days', 'cornell-governance' ) ), $prompt_time )
				) );
			}
