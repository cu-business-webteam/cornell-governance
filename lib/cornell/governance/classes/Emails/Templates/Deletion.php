...
namespace Cornell\Governance\Emails\Templates {
	...
	if ( ! class_exists( '\Cornell\Governance\Emails\Templates\Deletion' ) ) {
		class Deletion extends Base {
			/**
			 ...
			 * @since   0.1
			 */
			public static function instance( array $template_data = array() ): Deletion {
