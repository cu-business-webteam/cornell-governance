...
namespace Cornell\Governance\Admin\Fields {
	if ( ! class_exists( '\Cornell\Governance\Admin\Fields\Change_Form_URL' ) ) {
		class Change_Form_URL extends Base {
			...
			protected function __construct() {
				parent::__construct( array(
					'type'      => 'url',
					'id'        => 'change-form-url',
					'title'     => esc_html( __( 'What is the URL of the form that users can fill out to submit requests for changes?', 'cornell-governance' ) ),
