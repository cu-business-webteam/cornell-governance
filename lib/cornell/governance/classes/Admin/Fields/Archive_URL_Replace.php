...
namespace Cornell\Governance\Admin\Fields {
	if ( ! class_exists( 'Archive_URL_Replace' ) ) {
		class Archive_URL_Replace extends Base {
			...
			protected function __construct() {
				parent::__construct( array(
					...
					'title'     => __( 'If you would like to replace this site\'s URL with a production URL, enter that production URL here.', 'cornell/governance' ),
