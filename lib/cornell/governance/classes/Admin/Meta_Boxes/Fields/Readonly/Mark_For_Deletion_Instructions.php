...
namespace Cornell\Governance\Admin\Meta_Boxes\Fields\Readonly {
	...
	if ( ! class_exists( '\Cornell\Governance\Admin\Meta_Boxes\Fields\Readonly\Mark_For_Deletion_Instructions' ) ) {
		class Mark_For_Deletion_Instructions extends \Cornell\Governance\Admin\Meta_Boxes\Fields\Mark_For_Deletion_Instructions {
			...
			function __construct() {
				...
				$this->id = 'cornell-governance-page-info-mark-for-deletion-instructions-readonly';
