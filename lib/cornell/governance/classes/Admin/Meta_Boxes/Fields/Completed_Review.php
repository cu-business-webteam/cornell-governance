...
namespace Cornell\Governance\Admin\Meta_Boxes\Fields {
	...
	if ( ! class_exists( '\Cornell\Governance\Admin\Meta_Boxes\Fields\Completed_Review' ) ) {
		abstract class Completed_Review extends Confirm {
			function __construct() {
				$atts = array(
					'id' => 'cornell-governance-page-completed-review',
					'label' => esc_html( __( 'I am confirming that I have completed the page review tasks for this review cycle.', 'cornell-governance' ) ),
